...
Make sure your theme's search input field has an `id="s"` and/or `name="s"` and your form tag an `id="searchform"`, as in TwentyTen and TwentyEleven. It'll work fine then.
